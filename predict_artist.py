...
import numpy as np
from download_songs import compile_artists, grab_artist_lyrics
from train_model import train_my_nb, rebalance_my_datasets, tfidf
...
def render_welcome(banner):
    ...
    time.sleep(1)
    print(
        " This program will scrape songs for as many artists as you like!\n -----------------------------------------------------------"
    )
    time.sleep(1)
    print(
        " Then train a Naive Bayes model to recognise their lyrics!\n -----------------------------------------------------------"
    )
    time.sleep(1)
    print(
        " Then you can test how well it has learnt the artists' lyrics!\n -----------------------------------------------------------\n"
    )
    time.sleep(1)
